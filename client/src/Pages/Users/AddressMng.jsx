...
import { addAddress, getAddresses, deleteAddress } from "../../Services/apiServices";
...
const AddressMng = () => {
    ...
    return (
        <div className="relative flex flex-col md:flex-row p-6 gap-6 min-h-screen bg-gray-50">
                            ...
                            {addresses.map((address) => (
                                ...
                                >
                                    <button
                                        ...
                                        className="absolute top-2 right-2 text-red-600 bg-gray-100 p-3 rounded-full shadow hover:bg-red-100 hover:text-red-700 transition-all focus:outline-none focus:ring focus:ring-red-300"
                                    >
            ...
            >
                <h2 className="text-2xl font-bold mb-4 text-blue-500">Add New Address</h2>
                <div className="mb-6">
                ...
                >
                    <FiPlus className="text-lg" /> Add Address
                </button>
                <button

...
const Register = () => {
    return (
        <div className="flex min-h-screen">
            <div className="bg-orange-200 flex flex-col items-center justify-center w-1/3 p-10 rounded-r-lg">
            <div className="text-9xl font-bold bg-gradient-to-r from-yellow-400 to-orange-500 text-transparent bg-clip-text">Z</div>
            </div>
            <div className="flex flex-col justify-center w-2/3 p-10 bg-white">
                ...
                <p className="text-center text-gray-500 mt-4">Already registered ? <a href="#" className="text-blue-500">Sign In</a></p>
            </div>
        </div>
    )
}

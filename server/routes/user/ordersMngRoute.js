...
const { placeOrder, getCurrentOrders, updateOrderStatus, getPreviousOrdersOnDate ,createRazorpayOrder , verifyRazorpayPayment,rateRestaurant } = require('../../controllers/user/ordersMng');
